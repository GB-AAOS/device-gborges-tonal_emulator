...
PRODUCT_COPY_FILES += \
    device/gborges/tonal_emulator/sensors/hals.conf:$(TARGET_COPY_OUT_VENDOR)/etc/sensors/hals.conf


$(call inherit-product, device/generic/goldfish/64bitonly/product/sdk_phone64_x86_64.mk)

# Product properties
PRODUCT_NAME := tonal_emulator
...
BOARD_VENDOR_SEPOLICY_DIRS += device/gborges/tonal_emulator/sepolicy
